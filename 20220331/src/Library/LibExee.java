			...
			if (menu == 1) {
				...
				if (l == null) {
					...
					if (choice == 1) {
						...
						System.out.println("도서번호: " + books.getBookNumber() + "책 이름: " + books.getBookTitle() + "지은이: "
								+ books.getBookAuthor() + "출판사: " + books.getBookTitle() + "책 위치: "
				...
				if (l == null) {
					...
					if (choice2 == 1) { //도서대여
						...
						int bookNo = scn.nextInt();
						boolean result = dao.borrow(bookNo);
						if(result) {
